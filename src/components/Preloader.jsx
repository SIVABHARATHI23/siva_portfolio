    ...
    <AnimatePresence>
      {isLoading && (
        <motion.div
          ...
          className="fixed inset-0 w-full h-screen bg-[#ff6a00] z-[100000] flex items-center justify-center"
        >
          {/* Logo Container */}
          <motion.div 
          ...
          >
            ...
            <div className="text-orange-950/35">
              Siva<span className="text-orange-950/35">.</span>
            </div>
            ...
            >
              Siva<span className="text-black">.</span>
            </motion.div>
          </motion.div>
